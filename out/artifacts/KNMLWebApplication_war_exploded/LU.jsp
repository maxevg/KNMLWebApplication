...
<body>
    ...
    <form method="post" id="sample-form" action="${pageContext.request.contextPath}/LU">
        <div class="container">
            <div>
                 <a>LU-разложение</a>
            </div>
...
<script>
    ...
    sampleForm.addEventListener("submit", async (e) => {
        ...
        try {
            ...
            console.log(responseData.L.elems)
            ...
            L.innerHTML += "<nobr>Matrix L</nobr>"
            document.getElementById("answer").appendChild(L);

            for(let i = 0; i < countOfFields; i++) {
                var div = document.createElement("div");
                for (let j = 0; j < countOfFields; j++) {
                     div.innerHTML += "<nobr>" + responseData.L.elems[i][j] + " </nobr>"
                }
