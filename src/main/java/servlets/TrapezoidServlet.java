...
public class TrapezoidServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
        ...
        sc.getRequestDispatcher("/Trapezoid.jsp").forward(req, res);
    }
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse res)
        ...
        DoubleResultWithStatus result = new TrapezoidMethod().solveIntegralByTrapezoidMethod(integral.interval.get(0),
