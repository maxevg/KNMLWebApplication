...
<body>
    ...
    <form method="post" id="sample-form">
        <div class="container">
            ...
            <div>
                  <a>Введите матрицу, вектор и начальный вектор приближения</a>
            </div>
            <div id="parentId">
                <div>
                    <nobr>
                        ...
                        <input name="approach" type="text" class="input_mat" value required />
                    </nobr>
                </div>
                <div>
                    <nobr>
            ...
            <div>
                 <input name="eps" type="text" class="input_mat" value required />
            </div>
            <div class = "btns">
    ...
    function deleteField() {
        if (countOfFields > 3) {
            ...
            for(let i = 0; i < countOfFields; i++) {
                ...
                div.innerHTML += "<nobr><input name=\"approach\" type=\"text\" class=\"input_mat\" value required /></nobr>"
...
<script>
    ...
    async function postFormFieldsAsJson({ url, formData }) {
        ...
        const eps = formDataObject.eps

        const approach = formDataObject.approach
